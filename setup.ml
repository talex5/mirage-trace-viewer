...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6b40b4f7c8660939f1507cd76c05c397) *)
(*
...
let setup_t =
  {
          ...
          build_custom =
            {
               ...
               post_command =
                 [
                    ...
                    (OASISExpr.EFlag "javascript",
                      Some
                        (("./precompute.native",
                           [
                              "examples/log-x86.sexp";
                              "&&";
                              "js_of_ocaml";
                              "--opt=3";
                              "+weak.js";
            ...
            [
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "true to build mirage-trace-collect tool (requires xen-gnt.unix)";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "true to build the GTK viewer";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "true to build the JavaScript viewer";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                     cs_name = "mirage-trace-viewer";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                     cs_name = "mirage-trace-viewer.js";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "javascript", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "js";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "mirage-trace-viewer";
                   ...
                   {
                      lib_modules = ["Html_viewer"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mirage-trace-viewer";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gtk_viewer.ml"});
               Executable
                 ({
                     cs_name = "mirage-trace-viewer-precompute";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "precompute.ml"});
               Executable
                 ({
                     cs_name = "mirage-trace-collect";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "collect.ml"});
               Executable
                 ({
                     cs_name = "example_html";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "mirage-trace-viewer.js"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "example_html.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "N\253I1-G\198'\226\232D6\233\189\152\242";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
