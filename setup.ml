...
(* OASIS_START *)
(* DO NOT EDIT (digest: d2270a8ea762384c96d231e0f4fe3ea0) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Mtv_ITree"; "Mtv_counter"; "Mtv_sorted_array"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-trace-viewer";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "main";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "main"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "DU\173\176\223\217\223k'y\172\026\207g\177\228";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
