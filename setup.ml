...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7adb8b94aa7dc9cd81f5115bf0ac0228) *)
(*
...
let setup_t =
  {
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "true to build support for tracing Xen guests (requires xen-gnt-unix)";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cairo2-gtk", None);
     ...
     oasis_digest = Some "\133\227\021$OPSP\193\163\231\169\031\166\022\164";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
